...
window.CovenantPromptKey = {
     ...
     * Used by CovenantPromptKey.Browser LocalStorageService/SessionStorageService via JS interop identifiers:
     * - CovenantPromptKey.storage.local.*
     * - CovenantPromptKey.storage.session.*
     */
    storage: {
        local: {
